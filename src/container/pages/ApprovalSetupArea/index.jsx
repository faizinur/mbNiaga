...
class ApprovalSetupArea extends React.Component {
    constructor(props){
        super(props);
      }
    ...
    return (
        ...
        <BlockTitle>Approval Setup Area</BlockTitle>
        <List>
        <Block>
        <Row noGap>
            <Col width="40">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th className="input-cell">
                                <span className="table-head-label">ID Area</span>
                            </th>
                            <th className="input-cell">
                                <span className="table-head-label">Nama Area</span>
                            </th>
                            <th className="input-cell">
     ...
     _next() {
        this.props.navigate('/SetupBucket/');
    }
}
...
export default connect(null, mapDispatchToProps)(ApprovalSetupArea);