...
class ApprovalSetupParamCol extends React.Component {
    constructor(props){
        super(props);
      }
    ...
    return (
        ...
        <BlockTitle>Approval Setup Parameter Collection</BlockTitle>
        <List>
        <Block>
        <Row noGap>
            <Col width="40">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th className="input-cell">
                                <span className="table-head-label">Nama Parameter</span>
                            </th>
                            <th className="input-cell">
                                <span className="table-head-label">Nilai</span>
                            </th>
                            <th className="input-cell">
     ...
     _next() {
        this.props.navigate('/SetupParameter/');
    }
}
...
export default connect(null, mapDispatchToProps)(ApprovalSetupParamCol);