...
class ApprovalSetupBucket extends React.Component {
    constructor(props){
        super(props);
      }
    ...
    return (
        ...
        <BlockTitle>Approval Setup Bucket</BlockTitle>
        <List>
        <Block>
        <Row noGap>
            <Col width="40">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th className="input-cell">
                                <span className="table-head-label">ID Bucket</span>
                            </th>
                            <th className="input-cell">
                                <span className="table-head-label">Nama Bucket</span>
                            </th>
                            <th className="input-cell">
     ...
     _next() {
        this.props.navigate('/SetupParameterCollection/');
    }
}
...
export default connect(null, mapDispatchToProps)(ApprovalSetupBucket);